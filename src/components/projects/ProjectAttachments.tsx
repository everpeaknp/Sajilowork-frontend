    ...
    <section className="mt-12 border-t border-neutral-200 pt-10">
      ...
      <div className="flex flex-wrap gap-4">
        {documents.map((attachment, index) => {
          const cardClassName =
            'relative flex h-[88px] w-[148px] flex-col rounded-md bg-[#ebf8f2] px-4 py-4 text-left transition-colors hover:bg-[#dff5ea] sm:h-[92px] sm:w-[156px]';
          ...
          if (attachment.url) {
            return (
              ...
              >
                <span className="line-clamp-2 text-sm font-normal text-black">{attachment.name}</span>
