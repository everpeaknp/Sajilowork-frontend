...
export default function ProjectReviews({
  ...
  return (
    <section className="mt-12 border-t border-neutral-200 pt-10 dark:border-neutral-800" id="project-reviews-section">
        ...
        <div className="flex flex-col justify-between gap-4 py-2 pb-2 text-xs select-none sm:flex-row sm:items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="cursor-pointer rounded-lg bg-[#FAF9F6] px-2.5 py-1.5 text-xs font-normal text-black outline-none focus:ring-1 focus:ring-emerald-500 dark:bg-neutral-900 dark:text-stone-100 dark:border dark:border-neutral-700"
            >
              ...
              {displayedReviews.map((rev, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-4 whitespace-pre-line text-left text-xs font-normal leading-relaxed text-black/80 dark:text-neutral-300">
                      {rev.comment}
                    </p>
                    ...
                    <div className="mt-5 flex select-none items-center justify-between pt-3.5 text-[10px] font-normal text-neutral-400">
                      <div className="flex flex-wrap items-center gap-4">
                        ...
                        <button
                          ...
                          className={`inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 transition-all ${rev.userVoted === 'like' ? 'scale-105 bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300' : 'cursor-pointer bg-neutral-50 text-neutral-500 hover:bg-neutral-100 hover:text-black dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:hover:text-stone-100'}`}
                        >
        ...
        <form onSubmit={handleAddReview} className="space-y-6 pt-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-neutral-500 dark:text-neutral-400">
              ...
              <span className="text-neutral-800 dark:text-stone-200">*</span>
            </p>
          </div>

          <div className="space-y-3">
            <p className="text-sm font-normal text-black dark:text-stone-100">Your rating of this project</p>
          ...
          <div className="space-y-2">
            <label htmlFor="project-review-comment" className="block text-sm font-normal text-black dark:text-stone-100">
              Comment
            </label>
            <textarea
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div className="space-y-2">
              <label htmlFor="project-reviewer-name" className="block text-sm font-normal text-black dark:text-stone-100">
                Name
              </label>
              <input
                ...
                className="w-full rounded-lg border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-800 outline-none transition-colors focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 dark:border-neutral-700 dark:bg-neutral-950 dark:text-stone-100 dark:placeholder:text-neutral-500"
              />
            </div>

            <div className="space-y-2">
              <label htmlFor="project-reviewer-email" className="block text-sm font-normal text-black dark:text-stone-100">
                Email
              </label>
              <input
          ...
          <label className="flex cursor-pointer items-start gap-3 text-sm text-neutral-600 dark:text-neutral-400">
            <input
              ...
              className="mt-0.5 h-4 w-4 shrink-0 rounded border-neutral-300 text-emerald-600 focus:ring-emerald-500 dark:border-neutral-600"
            />
            <span>
