...
const calendarVariants = cva(
  "inline-block space-y-3 rounded-lg border border-gray-200 bg-white relative w-full max-w-xs mx-auto shadow-sm",
  {
    variants: {
      size: {
        sm: "p-2 text-xs",
...
const dayVariants = cva(
  "inline-flex h-7 w-7 items-center justify-center rounded-lg text-xs transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "text-gray-900 hover:bg-gray-100 hover:text-gray-900 focus-visible:ring-blue-500",
        selected:
          "bg-blue-600 text-white hover:bg-blue-700 focus-visible:ring-blue-500 font-semibold",
        today:
          "bg-gray-100 text-gray-900 font-semibold hover:bg-gray-200 focus-visible:ring-blue-500",
        outside:
          "text-gray-400 opacity-50 hover:bg-gray-100 hover:text-gray-900 focus-visible:ring-blue-500",
        disabled:
          "text-gray-300 opacity-30 cursor-not-allowed",
        "range-start":
          "bg-blue-600 text-white rounded-r-none hover:bg-blue-700 focus-visible:ring-blue-500",
        "range-end":
          "bg-blue-600 text-white rounded-l-none hover:bg-blue-700 focus-visible:ring-blue-500",
        "range-middle":
          "bg-blue-100 text-gray-900 rounded-none hover:bg-blue-200 focus-visible:ring-blue-500",
      },
      size: {
        sm: "h-6 w-6 text-xs",
    ...
    >
        ...
        <div className="flex items-center gap-1 min-w-0 flex-1 justify-center">
          {showMonthYearPickers ? (
            ...
            <motion.h2
              ...
              className="text-sm font-semibold text-gray-900 text-center px-2"
            >
      ...
      <div className="grid grid-cols-7 gap-1 mb-1">
        {DAYS_OF_WEEK.map((day) => (
          <div
            key={day}
            className="flex items-center justify-center h-6 text-xs text-gray-500 font-medium"
          >
            {day.slice(0, 1)}
          </div>
        ))}
