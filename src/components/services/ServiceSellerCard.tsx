    ...
    <>
      <div className="rounded-xl border border-neutral-200/80 bg-white p-6 shadow-[0_2px_16px_rgba(0,0,0,0.04)] dark:border-neutral-800 dark:bg-neutral-900 dark:shadow-none">
        ...
        >
          <div className="relative shrink-0">
            <img
              ...
              className="h-14 w-14 rounded-full border border-neutral-100 object-cover dark:border-neutral-700"
              referrerPolicy="no-referrer"
            />
            {service.author.online ? (
              <span className="absolute bottom-0.5 right-0.5 h-3 w-3 rounded-full border-2 border-white bg-[#52C47F] dark:border-neutral-900" />
            ) : null}
          </div>
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-[15px] font-normal text-neutral-500 dark:text-neutral-400">{seller.role}</p>
            <div className="mt-2 flex items-center gap-1.5 text-[15px] font-normal text-black dark:text-stone-100">
              <Star className="h-4 w-4 fill-amber-400 text-amber-400" />
              <span>{service.rating.toFixed(1)}</span>
              <span className="text-neutral-500 dark:text-neutral-400">({service.reviews} reviews)</span>
            </div>
          </div>
        </ServiceAuthorLink>

        <div className="mt-6 grid grid-cols-3 gap-3 border-t border-black pt-5 text-center dark:border-neutral-700">
          <div>
            <p className="text-xs font-normal text-neutral-400">Location</p>
            <p className="mt-1.5 text-sm font-normal text-black dark:text-stone-100">{seller.location}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="mt-1.5 text-sm font-normal text-black dark:text-stone-100">%{seller.jobSuccess}</p>
          </div>
        </div>
        ...
        <button
          ...
          className="mt-6 flex w-full cursor-pointer items-center justify-center gap-2 rounded-md border border-[#52C47F] bg-white px-6 py-3.5 text-[15px] font-normal text-[#52C47F] transition-colors hover:bg-[#52C47F] hover:text-white dark:bg-neutral-900 dark:hover:bg-[#52C47F]"
        >
          Contact Me
        ...
        {showContactModal ? (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-lg rounded-2xl border border-neutral-200 bg-white p-6 shadow-xl md:p-8 dark:border-neutral-700 dark:bg-neutral-900"
            ...
            >
              <button
                ...
                className="absolute right-5 top-5 flex h-8 w-8 cursor-pointer items-center justify-center rounded-lg border border-neutral-200 bg-neutral-50 text-neutral-500 transition-colors hover:bg-neutral-100 dark:border-neutral-700 dark:bg-neutral-800 dark:hover:bg-neutral-700"
              >
                <X className="h-4 w-4" />
              </button>
              ...
              {messageSent ? (
                <div className="flex flex-col items-center py-8 text-center">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-emerald-100 bg-emerald-50 text-emerald-500 dark:border-emerald-900 dark:bg-emerald-950/50">
                ...
                <form onSubmit={handleMessageSubmit} className="flex flex-col">
                  ...
                  <textarea
                    ...
                    className="min-h-[120px] w-full resize-none rounded-xl border border-neutral-200 bg-neutral-50/50 p-4 text-xs font-normal text-black outline-none transition-all focus:border-[#52C47F] focus:ring-1 focus:ring-[#52C47F]/40 dark:border-neutral-700 dark:bg-neutral-950 dark:text-stone-100 dark:placeholder:text-neutral-500"
                  />
                  ...
                  <div className="mt-5 flex items-center justify-end gap-3.5">
                    <button
                      ...
                      className="cursor-pointer rounded-lg border border-neutral-200 px-4 py-2.5 text-xs font-normal text-neutral-500 transition-colors hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-800"
                    >
                      Cancel
                    </button>
                    <button
