...
export default function ServiceAbout({ service }: ServiceAboutProps) {
  ...
  return (
    <section className="border-b border-neutral-200 pb-10 pt-10">
      ...
      {about.intro ? (
        <p className="mt-6 max-w-3xl whitespace-pre-line text-sm font-normal leading-[1.85] text-neutral-600 sm:text-[15px]">
          {about.intro}
        </p>
      ) : null}
      ...
      {about.skills.length > 0 ? (
        <div className="mt-8">
          <p className="text-sm font-normal text-black sm:text-[15px]">Skills</p>
      ...
      {about.outro ? (
        <p className="mt-8 max-w-3xl whitespace-pre-line text-sm font-normal leading-[1.85] text-neutral-600 sm:text-[15px]">
          {about.outro}
        </p>
      ) : null}
