...
function ProjectsPageContent({
  initialProjects,
  initialTotal,
}: Pick<ProjectsPageClientProps, 'initialProjects' | 'initialTotal'>) {
    ...
    >
      ...
      <Suspense
        fallback={
          <main className="pb-2 md:pb-0">
            <Hero />
            <ProjectList initialProjects={initialProjects} initialTotal={initialTotal} />
          </main>
        }
      >
        <ProjectsPageContent initialProjects={initialProjects} initialTotal={initialTotal} />
      </Suspense>
      <Footer />
    </div>
  );
