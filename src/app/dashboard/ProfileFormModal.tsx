...
export default function ProfileFormModal({
  ...
  return createPortal(
    <>
      ...
      >
        <div
          className="pointer-events-auto flex max-h-[min(92dvh,calc(100dvh-1rem))] w-full max-w-lg flex-col overflow-hidden rounded-t-[28px] border border-gray-100 bg-white shadow-2xl sm:rounded-[32px]"
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0 pr-2">
                <h2
                  ...
                  className="text-xl font-black uppercase tracking-tight text-brand-dark"
                >
                  {title}
                </h2>
            ...
            <div className="shrink-0 border-t border-gray-100 bg-white px-6 py-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
              <div className="flex flex-col gap-3 sm:flex-row">
                <button
                  type="button"
                  onClick={onClose}
                  className="flex-1 rounded-2xl border-2 border-gray-200 px-6 py-4 text-sm font-black uppercase tracking-widest text-gray-600 hover:bg-gray-50"
                >
                  Cancel
                </button>
                <button
